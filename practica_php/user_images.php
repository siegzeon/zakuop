        ...
        <div id="buscador">
            ...
            <?php
                ...
                if (isset ($_GET['tablerror'])) {
                        ...
                        echo "<h1>Imatges</h1><table border='1'>";
                        echo "<tr><td>titol</td><td>Imatge</td><td>Categoria</td><td>Borrar</td></tr>";
                        while ($fila = mysql_fetch_assoc($result)) {
                        $dirito = "banish_img.php?codi=" . $fila["id"];
                        $direccio = $fila['nom'];
                        $titol = $fila['titol'];
                        $categoria = $fila['categoria'];
                        echo "<tr><td>" .$titol . "</td><td><img src='img/" . $direccio . "' height='100px' width='auto'></td><td>" . $categoria . "</td><td><a href='$dirito'>Borrar</a></td></tr>";
                        }
                        echo "</table>";
                }
