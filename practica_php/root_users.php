	...
	<div id="contenidor">
        ...
        <div id="buscador">
            ...
            <?php
                ...
                $result = mysql_query("SELECT * FROM usuaris");
                if (!$result) {
                        header ("Location: index.php?tablerror=1");
                }
                if (isset ($_GET['tablerror'])) {
                        ...
                        echo "<h1>Usuaris</h1><table>";
                        echo "<tr><td>id</td><td>username</td><td>mail</td><td>Nom</td><td>Borrar</td></tr>";
                        while ($fila = mysql_fetch_assoc($result)) {
                        $dirito = "banish_delete.php?codi=" . $fila["id"];
                        $llista = $fila['id'];
                        $nom = $fila['nom'];
                        $user = $fila['username'];
                        $mail = $fila['mail'];
                        echo "<tr><td>$llista</td><td>$user</td><td>" . $mail . "</td><td>" . $nom . "</td><td><a href='$dirito'>Borrar</a></td></tr>";
                        }
                        echo "</table>";
                }
