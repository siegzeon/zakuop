...
<body>
	<div id="contenidor">
        ...
        <div id="principal">
            ...
            <ul>
                <li><a href="puja_imatge.php">Puja una imatge</a></li>
                <li><a href="modificar.php">Modificar dades personals</a></li>
                <li><a href="user_images.php">Administrar les meves imatges</a></li>
            </ul>
            <?php
                if ($role == 0){
                    echo "<h2>Eines d'administrador</h2>";
                    echo "<li><a href='root_users.php'>Administrar els usuaris</a></li>";
                    echo "<li><a href='root_images.php'>Administrar totes les imatges</a></li>";
                }
                echo "</ul></div>";
                ...
                $result = mysql_query("SELECT * FROM imatges WHERE id_usu = $login");
                if (!$result) {
                        header ("Location: index.php?tablerror=1");
                }
                if (isset ($_GET['tablerror'])) {
                        ...
                        echo "<h1>Fotografies de l'usuari</h1>";
